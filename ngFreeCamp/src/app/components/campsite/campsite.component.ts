...
export class CampsiteComponent implements OnInit, AfterViewInit {
  ...
  images = [
    ...
    'https://images.pexels.com/photos/803226/pexels-photo-803226.jpeg?auto=compress&cs=tinysrgb&dpr=2',
    'https://images.pexels.com/photos/207324/pexels-photo-207324.jpeg?auto=compress&cs=tinysrgb&dpr=2'
  ...
  mapInitializer() {
    ...
    this.campsites.forEach((val) => {
      ...
      const contentString ='<div>' + '<h4>' + val.name + '</h4>' + '<h6>' + val.latitude + '  :  ' + val.longitude  + '</h6>' + '<h5>' + val.state.name + '</h5>' + "<img src='" + val.pictureUrl + "' width='120' height='100' />" +'</div>';
